...
export class GraphFilterService {
    ...
    historyResource(filter: Signal<GraphFilter | undefined>):ResourceRef<MetricHistory[]|undefined> {
        return resource({
            params: () => {
            ...
            loader: ({params}): Promise<MetricHistory[]> => firstValueFrom(this.historyGql.fetch(params)
