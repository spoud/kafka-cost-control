...
The `kafka-cost-control-ingress` and `kafka-cost-control-ui-ingress` Ingresses have their host set to `TO_BE_DEFINED_BY_OVERRIDE`. Add patches in your overlay to set it to your own host.
